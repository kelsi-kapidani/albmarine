    ...
    if (screen.xs) {
        return(
            ...
            <Row><img src='./about.jpg' style={{width: '100%',
                          height: '200px',
                          objectFit: 'cover'}}/></Row>
            <Row justify='center' style={{marginTop:'10px', fontWeight:'bold', fontSize:'25px',marginBottom:'40px'}}>Who Are We</Row>
            <Row justify='space-around' gutter={24} style={{padding: '0 20px'}}>
                ...
                <Row style={{textAlign:'center', marginTop:'14px',marginBottom:'30px'}}>ALBMARINE  ltd   provides a full range of services to owners, charterers, traders operating in all ALBANIAN ports and terminals. We have established and maintains a Quality Management System according to the standards of  ISO 9001:2008.</Row>
                </Col>
                <Col span={24}>
